...
// Load this file's selection again by visiting: http://mootools.net/more/fd3508fc344dc26adc3e16063eacd88b 
// Or build this file again with packager using: packager build More/String.Extras More/URI.Relative More/Hash More/Fx.SmoothScroll
/*
---
copyrights:
...
},toQueryString:function(b){return Object.toQueryString(this,b);}});a.alias({indexOf:"keyOf",contains:"hasValue"});})();(function(){Fx.Scroll=new Class({Extends:Fx,options:{offset:{x:0,y:0},wheelStops:true},initialize:function(c,b){this.element=this.subject=document.id(c);
