...
/* establish minimal global console if browser doesn't already have one */
					
if (window.console === undefined){
	if (debugSettings && debugSettings.enabled){
		window.console = new Unit({
			log: function(){
				this.publish('!console.log', arguments);
			}
		});
	} else {
		window.console = {
